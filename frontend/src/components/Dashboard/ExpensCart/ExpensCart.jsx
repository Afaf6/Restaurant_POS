...
function ExponsCart({ summary }) {
    ...
    const links = summary ? [
        ...
        { icon: "fa-receipt", 
          ...
          rate: summary.expensesChange >= 0 ? "fa-arrow-up" : "fa-arrow-down", 
          precen: `${Math.abs(summary.expensesChange || 0)}%`, 
          diff: "vs.  last month", 
          diffMoney: `$${summary.lastMonthExpenses || "0.00"}`,
          type: "expenses" },

        { icon: "fa-arrow-trend-up",
          title: "Net Profit",
          money: `$${summary.profit}`,
          rate: summary.profitChange >= 0 ? "fa-arrow-up" : "fa-arrow-down",
          precen: `${Math.abs(summary.profitChange || 0)}%`,
          diff: "vs.  last month",
          diffMoney: `$${summary.lastMonthProfit || "0.00"}`,
          type: "profit" },
        ] : [];
