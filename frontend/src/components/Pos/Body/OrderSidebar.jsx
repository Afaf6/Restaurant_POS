...
function OrderSidebar({ cart, onInc, onDec, subtotal, tax, total, onPay, onBill, onPromo }) {
  return (
    <div className={style.sidebar}>
          ...
          cart.map((item) => (
            <div key={item._id} className={style.orderItem}>
              ...
              <div className={style.qtyRow}>
                <button className={style.qtyBtn} onClick={() => onDec(item._id)}>
                  − 
                </button>
                <span className={style.qty}>{item.qty}</span>
                <button className={style.qtyBtn} onClick={() => onInc(item._id)}>
                  +
                </button>
              </div>
      ...
      <div className={style.actions}>
        <button className={style.outlineBtn} onClick={onBill}>Bill</button>
        <button className={style.outlineBtn} onClick={onPromo}>Promo</button>
        <button 
